        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-users"></i>Management User</a>
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-puzzle-piece"></i><a href="/dataadmin">Admin</a></li>
                        <li><i class="fa fa-id-badge"></i><a href="/datamahasiswa">Mahasiswa</a></li>
                    </ul>
                </li>

                <li class="active">
                    <a href="/data_lomba"> <i class="menu-icon fa fa-plus-square-o"></i>Management Lomba</a>
                </li>

                <li class="active">
                    <a href="/datakelas"> <i class="menu-icon fa fa-list-alt"></i>Management Kelas</a>
                </li>
                ...
                <form id="logout-form" action="{{ route('logout') }}" method="POST">
                    ...
                    <div class="user-area dropdown float-right">
                        ...
                        <div class="user-menu dropdown-menu">
                            <button type="submit" style="border-radius: 20px" class="btn btn-outline-danger"><i class="fa fa-power -off"></i>Logout</button>
                        </div>
                    </div>
                </form>
